...
class MA:
    ...
    def Local_search(self, i):
        fw = self.obj.Evaluate(self.pos[i])  ## Fitness of the original position
        ...
        for k in range(self.ndim):  ## Looping through every dimension
            ...
            fn = self.obj.Evaluate(self.pos[i])  ## Calculating the new fitness value
